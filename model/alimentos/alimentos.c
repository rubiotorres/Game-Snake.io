...
void alimento_especial_2_cria(Alimento_especial lista[],int tamanho){
    Alimento_especial novo;
    novo.tamx_alimento=10;
    novo.tamy_alimento=10;
    novo.x_alimento=(1+rand()%600);
...
void alimento_cria(Alimento lista[],int tamanho){
    ...
    novo.tamx_alimento=10;
    novo.tamy_alimento=10;
    novo.x_alimento=(1+rand()%700);
    novo.y_alimento=(1+rand()%500);
    novo.texturaAlimento = SOIL_load_OGL_texture(
        "texturas/alimento.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    );
